...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "group7.db";
    ...
    public int insertData(double xvalue,double yvalue,double zvalue, String Irina) {
        if (Varex.gvar == 1&&Varex.lbl.compareTo(Irina)==0) {
            ...
            if (ccount == 1) {
                contentValues.put(COL_1, getCnum()+1);
                contentValues.put(Class, Irina);
            }
            ...
            if (ccount == 1) {
                ...
                db.update(TABLE_NAME, contentValues, "ID = ?", new String[]{Integer.toString(getCnum())});
                ccount++;
            }
            if (ccount == 51)
                return 0;
